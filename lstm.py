...
lstm = Sequential()
lstm.add(LSTM(150, activation='relu', input_shape=(None, X_train.shape[2]), return_sequences=True))
...
lstm.fit(X_train, y_train, epochs=150, verbose=1,callbacks=[monitor], batch_size = 64)
